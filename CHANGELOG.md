...
- Added opt-in TempleOS-style recovery for unmatched conditional boundaries while retaining strict hosted diagnostics by default, plus policy-tagged human and JSON reports and source-derived fixtures that remain marked as awaiting native oracle validation.
