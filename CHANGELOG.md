...
- Added unbound primitive function definitions through the common statement parser, including recursive symbol visibility, explicit empty and absent-at-EOF body states, split header and body provenance, deterministic dumps, and bounded recovery.
