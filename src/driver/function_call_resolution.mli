...
(** Collect syntactically direct calls from function bodies, associate each
    ...
    source classes, recursive prefix and binary operands, and source-visible
    cast targets, and resolve fixed and variadic slots against the
    source-visible function header. *)
