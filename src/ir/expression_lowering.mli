...
(** Lower an integer, character, [F64], ordinary current-position, or
    ...
    multiplication, division, addition, and subtraction. A mixed edge marks the
    retained integer producer with [ICF_RES_TO_F64] intent without folding its
    payload. Numeric prefixes and primitive postfix casts compose within their
