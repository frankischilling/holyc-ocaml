...
(** Lower an integer, character, [F64], ordinary current-position, or
    ...
    multiplication, division, addition, subtraction, and the six comparisons.
    A mixed edge marks the retained integer producer with [ICF_RES_TO_F64]
    without folding its payload. Floating comparisons also carry [ICF_USE_F64]
    while retaining the checked internal [I64] result. Numeric prefixes and
    ...
    emits [IC_HOLYC_TYPECAST] with the full cast span and pinned [was_paren]
