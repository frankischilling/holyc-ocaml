...
val targets : t -> Top_level_implicit_output_target_resolution.t
val compilation_mode : t -> Function_resolution.compilation_mode
val outputs : t -> output_result list

val output_source :
  output_result -> Top_level_implicit_output_target_resolution.output

val output_result_name : output_result -> string

val bound_source :
  bound_output -> Top_level_implicit_output_target_resolution.output
...
val bound_variadic_roots :
  bound_output -> Function_call_expression_result.top_level_root_result list

val deferred_source :
  deferred_output -> Top_level_implicit_output_target_resolution.output
...
val omission_output :
  omission -> Top_level_implicit_output_target_resolution.output
