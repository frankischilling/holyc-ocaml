...
let initializer_forms () =
  cases
    [
      ...
      ("U8 A[2][3]=\"42\";(A[0][0]-48)*10+A[0][1]-48;", 42L);
      ( "I64 F(){static U8 A[2][3]=\"42\";return \
         (A[0][0]-48)*10+A[0][1]-48;}F();",
        42L );
    ]
...
let per_leaf_phases () =
  List.iter
    ...
    [
      ...
      "U8 A[2][3]=\"42\";A[0][2]+42;";
      "I64 F(){static U8 A[2][3]=\"42\";return A[0][2]+42;}F();";
    ];
  cases
    [
