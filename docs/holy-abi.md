...
These are checked semantic signature facts, not a calling-convention implementation. Prototype/definition identities and top-level function record flags are modeled by separate passes. Default evaluation, register allocation, argument placement, cleanup emission, storage, indirect calls, and native entry points remain separate work. [Issue #181](https://github.com/frankischilling/holyc-ocaml/issues/181) records the signature boundary, [issue #220](https://github.com/frankischilling/holyc-ocaml/issues/220) records the parameter masks, [issue #234](https://github.com/frankischilling/holyc-ocaml/issues/234) records register-request retention, and [issue #191](https://github.com/frankischilling/holyc-ocaml/issues/191) records the function-record boundary.
