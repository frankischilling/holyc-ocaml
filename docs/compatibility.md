...
| Integrated preprocessing | Partially implemented: quoted `#include`; TempleOS text `#define`; nested `#ifjit` and `#ifaot` selection in explicit JIT/AOT modes; deterministic path search; file, definition, invocation, and conditional-error provenance; source-order sharing across includes and session streams; caller resumption; deterministic definition dumps; inactive-branch side-effect suppression; and explicit hosted path, cycle, mismatch, depth, size, and generated-byte limits. Cross-frame token formation remains a source difference in #24. Hosted unmatched-boundary diagnostics differ from the pinned permissive behavior and are tracked in #27. Expression and symbol conditions, `#assert`, `#exe`, predefined values, and general generated source remain unavailable. | [Preprocessor notes](preprocessor.md), [include issue #21](https://github.com/frankischilling/holyc-ocaml/issues/21), [definition issue #23](https://github.com/frankischilling/holyc-ocaml/issues/23), [mode issue #26](https://github.com/frankischilling/holyc-ocaml/issues/26), [boundary issue #24](https://github.com/frankischilling/holyc-ocaml/issues/24), [diagnostic issue #27](https://github.com/frankischilling/holyc-ocaml/issues/27), and [epic #3](https://github.com/frankischilling/holyc-ocaml/issues/3) |
