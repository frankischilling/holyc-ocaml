...
| Integrated preprocessing | Partially implemented: quoted `#include`; TempleOS text `#define`; deterministic path search; file, definition, and invocation provenance; source-order sharing across includes and session streams; caller resumption; deterministic definition dumps; and explicit hosted path, cycle, depth, size, and generated-byte limits. Cross-frame token formation remains a source difference in #24. Conditions, `#assert`, `#exe`, predefined values, and general generated source remain unavailable. | [Preprocessor notes](preprocessor.md), [include issue #21](https://github.com/frankischilling/holyc-ocaml/issues/21), [definition issue #23](https://github.com/frankischilling/holyc-ocaml/issues/23), [boundary issue #24](https://github.com/frankischilling/holyc-ocaml/issues/24), and [epic #3](https://github.com/frankischilling/holyc-ocaml/issues/3) |
